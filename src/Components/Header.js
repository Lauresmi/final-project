                    ...
                    <div className="col-3 d-flex ">
                        <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
                            <li className="nav-item text-center">
                                <a className="nav-link" href="https://images.pexels.com/photos/1560424/pexels-photo-1560424.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260"> <i class="bi bi-geo-alt"></i> <br /> Store finder</a>
                            </li>
                            <li className="nav-item text-center">
                                <a className="nav-link" href="https://images.pexels.com/photos/2064110/pexels-photo-2064110.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"> <i class="bi bi-person-heart"></i> <br />My account</a>
                            </li>
                            <li className="nav-item text-center">
                                <a className="nav-link" href="https://images.pexels.com/photos/870827/pexels-photo-870827.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"> <i class="bi bi-bag-heart"></i> <br />My bag</a>
                            </li>
